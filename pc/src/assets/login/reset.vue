<template>
  <div class="container-box ">
        ...
        <div class="login-container">
            ...
            <div class="input-item">
                <font>设置密码</font><!--
                --><input :type="inputType"  spellcheck="false" class="login-input" v-model="password"  placeholder="数字字母组合密码">
            </div>
            <div class="input-item">
                <font>重复密码</font><!--
                --><input :type="inputType"  spellcheck="false" class="login-input" style="width: 180px;" v-model="rePassword"  @focus="clearTip('password')" placeholder="数字字母组合密码"><!--
                --><i class="el-icon-view eyes" @mousedown="showPsw" @mouseup="hidePsw"></i>
                <p class="tip">{{tip.password}}</p>
            </div>
            <span class="btn-login" @click="reset" >确认</span>
        </div>
  </div>
</template>
